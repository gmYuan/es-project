 ...
 * 在ES5里 会创建一个VO Variable Object(变量对象) => Activation Object
 *
 * 在ES6里 Variable Environment(变量环境) var function + LexicalEnvironment(词法环境)
 */
let globalEC = {
  //this: globalThis,//代表当前this指针
  outer: null, //外部执行上下文环境  相当实现了以前ES3中的scopeChain(作用域链)
...
//2.编译fn
//静态作用域/语法作用域: 一个函数执行的时候的作用域 是在通过function声明时创建的
let fnEC = {
  this: globalThis,

	//fnEC.outer等于 声明fn变量的执行上下文 环境对象中的VariableEnvironment对象
  outer: globalEC,
