...
function hoistNonReactStatics<N extends React.ComponentClass<any>, O extends React.ComponentClass<any>>(
    NewComponent:N,
     OldComponent:O):N&O{
...
let N = hoistNonReactStatics <typeof NewComponent, typeof OldComponent>(NewComponent, OldComponent);
